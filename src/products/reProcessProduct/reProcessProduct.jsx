...
import './reProcessProduct.scss'
import { useSelector } from "react-redux";
import { useNavigate } from "react-router-dom";

const ReProcessProduct = () => {
    ...
    const check_casting = async () => {
        ...
        let result = await api.post("/products/check-casting.php", formData);
    ...
    const submit_reprocess = async () => {
        ...
        let result = await api.post("/products/create-from-casting.php", formData);
        if (result?.data?.status) {
...
export default ReProcessProduct;
